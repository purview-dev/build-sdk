...
public sealed class CompilerVisiblePropertyTests
{
	...
	public async Task CompilerVisibleProperties_Include_AllSdkProperties(CancellationToken cancellationToken)
	{
		...
		var expected = new[]
		{
			...
			"PurviewAgentFolderSourcePath",
			"PurviewAgentFolderCopyRetries",
			"PurviewAgentFolderCopyRetryDelayMilliseconds",
			"PurviewAgentFolderCopyFailureAsError",
			"PurviewAgentSyncManifestPath",
			"PurviewRepoBootstrapMode",
			"PurviewRepoBootstrapCopyRetries",
			"PurviewRepoBootstrapCopyRetryDelayMilliseconds",
			"PurviewRepoBootstrapCopyFailureAsError",
			"PurviewSuppressCopyRetryWarnings",
